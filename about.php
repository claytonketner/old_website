	...
	<div id="content-wrapper" class="content-sized">
		<div id="content" class="sidebar-or-content">
			...
			<div id="about-school" class="two-column left">
				<div id="beach-image" class="top-image-wrapper"> <img class="top-image" src='images/about/me david robert on beach.jpg'> </div>

				<h3>School</h3>

				<p>I am a 5th year student at the University of Southern California (USC), about to graduate in May, 2014 
				with a B.S. in Mechanical Engineering and a minor in Computer Science. I am also a member of the
				<a href="http://www.spdalpha.org" target="_blank">Sigma Phi Delta</a> professional Engineering fraternity.</p>
				...
				<a href="http://www.sanbrunopet.com" target="_blank">San Bruno Pet Hospital</a>. When I was in elementary and 
				middle school, he would bring me in to work and I would see him work and use the huge machines he had. 
				From then on, I've been interested with fabrication, machines, and how things work.</p>

				<p>My decision to minor in Computer Science was caused by my long-running interest and use of programming. 
				The first time I picked up programming was in early-mid middle school. My dad bought me 
			...
			<div id="about-leisure" class="two-column right">
				<div id="young-machine-image" class="top-image-wrapper"> <img class="top-image" src='images/about/young machine.jpg'> </div>
